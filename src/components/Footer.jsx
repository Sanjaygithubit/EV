      ...
      <div className="max-w-7xl mx-auto px-6 py-14 grid gap-10 md:grid-cols-4">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            {SITE_CONFIG.description}. {contact.address.street}, {contact.address.area}, {contact.address.city} - {contact.address.pincode}.
          </p>
        </div>
        ...
        <div>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 mt-4 bg-[#25D366] text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-[#20bd5a] transition"
          >
